...
$("#current-theme").prev().before(_wdeb_tooltip_tpl.replace(/%%text%%/, l10WdebHelp.current));
$("#availablethemes").prev().before(_wdeb_tooltip_tpl.replace(/%%text%%/, l10WdebHelp.available));
