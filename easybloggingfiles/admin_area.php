        ...
        <div id="easy-admin-area">
            ...
            ?>
                <ul>
                    ...
                    <li><a id="themes-php" href="<?php bloginfo('wpurl'); ?>/wp-admin/?frame=themes" class="tab_tooltip" title="<?php _e( 'Free Themes|Change to a different free theme', $this->localizationDomain ) ?>"><span><?php _e( 'Free Themes', $this->localizationDomain ) ?></span></a></li>
                    <?php if (is_supporter()) { ?>
