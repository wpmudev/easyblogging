        ...
        <div id="easy-admin-area">
            ...
            ?>
                <ul>
                    ...
                    <li><a id="themes-php" href="<?php bloginfo('wpurl'); ?>/wp-admin/?frame=themes" class="tab_tooltip" title="<?php _e( 'Themes|Change to a different theme', $this->localizationDomain ) ?>"><span><?php if (function_exists('is_supporter')) { _e( 'Free Themes', $this->localizationDomain ); } else { _e( 'Customize Design', $this->localizationDomain ); } ?></span></a></li>
                    <?php if (function_exists('is_supporter')) { //We only need to know if the supporter plugin is on, we need to display these tabs regardless of whether or not the user is a supporter, to encourage upgrades ?>
